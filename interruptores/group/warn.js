...
export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    ...
    try {
      if (!who2) return m.reply('✨ O sea, debes mencionar o responder al usuario que deseas advertir.')
      ...
      await client.reply(m.chat, message, m, global.lumi, { mentions: [targetId] })
    } catch (e) {
