...
export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    if (!args[0]) {
      return m.reply(`👑 Ingresa un link de Google Drive.\nEjemplo: *${usedPrefix}${command} https://drive.google.com/file/d/xxx*`)
    }
    const url = args[0]
...
👑 Inténtalo de nuevo o contacta soporte.`, global.lumi)
    }
  }
}
